 ...
 <div id="quickview-sidebar">
    ...
    <script src="<?php echo base_url();?>assets/global/plugins/select2/dist/js/select2.full.min.js"></script> <!-- Select Inputs -->
    ...
    <script src="<?php echo base_url();?>assets/global/js/builder.js"></script> <!-- Theme Builder -->
    ...
    <script src="<?php echo base_url();?>assets/global/plugins/noty/jquery.noty.packaged.min.js"></script>  <!-- Notifications -->
    ...
    <script src="<?php echo base_url();?>assets/global/plugins/charts-highstock/js/highstock.js"></script> <!-- financial Charts -->
    <script src="<?php echo base_url();?>assets/global/plugins/charts-highstock/js/modules/exporting.js"></script> <!-- Financial Charts Export Tool -->
    <script src="<?php echo base_url();?>assets/global/plugins/maps-amcharts/ammap/ammap.js"></script> <!-- Vector Map -->
    <script src="<?php echo base_url();?>assets/global/plugins/maps-amcharts/ammap/maps/js/worldLow.js"></script> <!-- Vector World Map  -->
    <script src="<?php echo base_url();?>assets/global/plugins/maps-amcharts/ammap/themes/black.js"></script> <!-- Vector Map Black Theme -->
