<div class="page-content">
          <div class="header">
            <h2>Add  <strong>SubContractor</strong></h2>
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                <li><a href="#">SubContractor</a>
                </li>
                <li><a href="forms.html">SubContractor</a>
                </li>
                <li class="active">Add SubContractor</li>
              </ol>
            </div>
          </div>
            ...
            <div class="col-lg-12 portlets ui-sortable">
              <div class="panel">
                <div class="panel-header panel-controls ui-sortable-handle">
                  <h3><i class="icon-bulb"></i> Add  <strong>SubContractor</strong></h3>
                ...
                <div class="panel-content">
                 <form action="<?php echo base_url(); ?>addsubContractor" method="POST" enctype="multipart/form-data">
...
-->  
                 <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="contractor_id" value="" class="form-control" placeholder="Enter Name">
                ...
                foreach($MainArray as $key=> $val) {
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label class="form-label">ShortTerm Relationship</label>
                        <input type="radio"  name="relationship" value="short" class="form-control">
                        <span class="text-danger"><?php echo form_error('trips'); ?></span>

                        <label class="form-label">LongTerm Relationship</label>
                        <input type="radio"  name="relationship" value="long" class="form-control">
                        <span class="text-danger"><?php echo form_error('trips'); ?></span>
                      </div>
