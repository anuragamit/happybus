...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>assets/website/assets/css/fontawesome.css">
    <link rel="stylesheet" href="<?php echo base_url();?>assets/website/assets/css/templatemo-grad-school.css">
    <link rel="stylesheet" href="<?php echo base_url();?>assets/website/assets/css/owl.css">
    <link rel="stylesheet" href="<?php echo base_url();?>assets/website/assets/css/lightbox.css">
<!--
...
<body>
  ...
  <section class="section main-banner" id="top" data-section="section1">
      <video autoplay muted loop id="bg-video">
          <source src="<?php echo base_url();?>assets/website/assets/images/course-video.mp4" type="video/mp4" />
      </video>
  ...
  <!-- Bootstrap core JavaScript -->
    ...
    <script src="<?php echo base_url();?>assets/website/assets/js/isotope.min.js"></script>
    <script src="<?php echo base_url();?>assets/website/assets/js/owl-carousel.js"></script>
    <script src="<?php echo base_url();?>assets/website/assets/js/lightbox.js"></script>
    <script src="<?php echo base_url();?>assets/website/assets/js/tabs.js"></script>
    <script src="<?php echo base_url();?>assets/website/assets/js/video.js"></script>
    <script src="<?php echo base_url();?>assets/website/assets/js/slick-slider.js"></script>
    <script src="<?php echo base_url();?>assets/website/assets/js/custom.js"></script>
    <script>
