<div class="page-content">
          <div class="header">
            <h2>Add  <strong>Factory</strong></h2>
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                <li><a href="#">Factory</a>
                </li>
                <li><a href="forms.html">Factory</a>
                </li>
            ...
            <div class="col-lg-12 portlets ui-sortable">
              <div class="panel">
                <div class="panel-header panel-controls ui-sortable-handle">
                  <h3><i class="icon-bulb"></i> Add  <strong>Factory</strong></h3>
                ...
                <div class="panel-content">
                 <form action="<?php echo base_url(); ?>addParents" method="POST">
                  ...
                  <input type="hidden" name="usertype" value="4"class="form-control" placeholder="Enter Mobile">
                    <div class="col-md-6">
