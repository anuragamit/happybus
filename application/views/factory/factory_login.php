            ...
            <div class="row">
                <div class="col-sm-6 col-md-4 col-md-offset-4">
                    <div class="account-wall">
                        ...
                        <form class="form-signin" role="form" method="post" action="<?php echo base_url();?>Login/factoryauth">
                       
                            <div class="append-icon">
                               
                            <input type="hidden" name="userType" value="4"  class="form-control form-white username" placeholder="" >
