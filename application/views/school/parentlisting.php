   ...
   <div class="page-content">
          <div class="header">
            <h2>Parent <strong>List</strong></h2>
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                <li><a href="dashboard.html">Parent</a>
                </li>
                <li><a href="tables.html">Parent</a>
                </li>
                <li class="active">Parent View</li>
              </ol>
            </div>
          </div>
                    ...
                    <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                     ...
                     foreach($MainArray as $key=> $val) {
                      ...
                      <td class="sorting_1"><?=$val['name'];?></td>
                          ...
                          <td class="hidden-1024"><?=$val['mob'];?></td>
                          <td class="hidden-1024"><?=$val['createDate'];?></td>
