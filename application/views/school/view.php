                  ...
                  <div class="filter-left">
                    <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                      ...
                      <thead>
                        ...
                        <th class="hidden-350 sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 133px;">DESIGNATION</th>
                     ...
                     foreach($MainArray as $key=> $val) {
                      ...
                      <td class="sorting_1"><?=$val['name'];?></td>
                          <td>  <?=$val['address'];?>   </td>
                          <td class="hidden-350"><?=$val['designation'];?></td>
