<div class="page-content">
          <div class="header">
            <h2>Add  <strong>School</strong></h2>
            ...
            <div class="col-lg-12 portlets ui-sortable">
              <div class="panel">
                <div class="panel-header panel-controls ui-sortable-handle">
                  <h3><i class="icon-bulb"></i> Add  <strong>School</strong></h3>
                ...
                <div class="panel-content">
                 <form action="<?php echo base_url(); ?>User/addalluser" method="POST">
                 <input type="hidden" name="usertype" value="1" class="form-control" placeholder="Enter Name">
                  <div class="row">
                    <div class="col-md-6">
