<div class="page-content">
          <div class="header">
            <h2>Add  <strong>Driver</strong></h2>
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                <li><a href="#">Driver</a>
                </li>
                <li><a href="forms.html">Driver</a>
                </li>
            ...
            <div class="col-lg-12 portlets ui-sortable">
              <div class="panel">
                <div class="panel-header panel-controls ui-sortable-handle">
                  <h3><i class="icon-bulb"></i> Add  <strong>Driver</strong></h3>
                ...
                <div class="panel-content">
                 <form action="<?php echo base_url(); ?>adddriver" method="POST" enctype="multipart/form-data">
...
-->
                 <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="subcontractor_id" value="" class="form-control" placeholder="Enter Name">
